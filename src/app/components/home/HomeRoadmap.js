...
function HomeRoadmap() {
    return (
        <>
            ...
            <div className=' bg-[] px-[20px] roadmap-points-wrapper flex gap-[15px] flex-wrap gap-[10px] justify-center'>
                <div className=' roadmap-point-1 translate-y-[-40%]'>
                ...
                <div className='roadmap-point-2 translate-y-[16%]'>
                ...
                <div className=' roadmap-point-3 translate-y-[-16%]'>
                ...
                <div className=' roadmap-point-4 translate-y-[16%]'>
                ...
                <div className=' roadmap-point-5 translate-y-[-16%]'>
                ...
                <div className=' roadmap-point-6 translate-y-[16%]'>
            ...
            <div className='mt-[80px] features-container px-[80px]'>
                <div className="roadmap-upper h-[350px] flex">
                    ...
                    <div className="roadmap-upper-right h-[100%] w-[50%] flex items-center bg-[]">
                        <p className='text-[24px] font-[600]  roadmap-upper-text font-poppins leading-[45px]'>Tuptalk is decentralized and allows users to earn cryptocurrency rewards through active participation, fostering a vibrant, engaged community. It offers content creators a transparent and fair social media experience.</p>
                    </div>
                </div>
                <div className="roadmap-lower h-[350px] flex mt-[50px]">
                    <div className="roadmap-lower-left h-[100%] w-[45%] flex items-center bg-[]">
                        <p className='text-[24px] font-[600] roadmap-lower-text font-poppins leading-[45px]'>Tuptalk enhances reach by integrating social networks, allowing users to share group chats or live radio sessions with followers. This instant access drives exponential growth and engagement, making it essential for businesses.</p>
                    </div>
